...
from .views import client_data_list, client_data_form, get_questions, get_languages, get_question_and_answers_translations
...
urlpatterns = [
    ...
    path('translations/', get_question_and_answers_translations, name='get_question_and_answers_translations'),
